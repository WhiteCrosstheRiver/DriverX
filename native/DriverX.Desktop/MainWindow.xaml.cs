...
public partial class MainWindow : Window
{
 ...
 Forms.NotifyIcon CreateTrayIcon(){var icon=new Forms.NotifyIcon{Icon=System.Drawing.SystemIcons.Application,Text="DriverX · 远程磁盘",Visible=true};var menu=new Forms.ContextMenuStrip();menu.Items.Add("打开 DriverX",null,(_,_)=>ShowFromTray());menu.Items.Add(new Forms.ToolStripSeparator());menu.Items.Add("退出并卸载全部磁盘",null,(_,_)=>{shuttingDown=true;Close();});icon.ContextMenuStrip=menu;icon.DoubleClick+=(_,_)=>ShowFromTray();return icon;}
 ...
 void ApplyTheme(bool dark){Resources["AppBackground"]=Brush(dark?"#CC111318":"#EAF6F7FB");Resources["SidebarBackground"]=Brush(dark?"#D9171A20":"#EAFBFCFE");Resources["CardBackground"]=Brush(dark?"#E61C2028":"#F4FFFFFF");Resources["TextPrimary"]=Brush(dark?"#F4F7FC":"#172033");Resources["TextSecondary"]=Brush(dark?"#9BA6B7":"#687386");Resources["BorderBrush"]=Brush(dark?"#303641":"#E3E7EF");Resources["AccentSoft"]=Brush(dark?"#153A62":"#E7F2FF");}static System.Windows.Media.Brush Brush(string c)=>new SolidColorBrush((Color)ColorConverter.ConvertFromString(c));
